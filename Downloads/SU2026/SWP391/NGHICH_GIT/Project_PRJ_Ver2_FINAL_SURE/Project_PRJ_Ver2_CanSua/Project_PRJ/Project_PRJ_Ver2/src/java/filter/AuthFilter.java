...
Không phải admin → chặn admin page
 */
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean needsLogin =
                path.startsWith("/orderhistory")
                        ...
                        || path.startsWith("/manageproduct")
                        || path.startsWith("/manageorder")
                        || path.startsWith("/manageuser");

        if (!isPublicPage && needsLogin && !SessionUtil.isLoggedIn(req)) {
